...
class Exam_09_Sub extends Frame {
	// 멤버 필드
	private Button confirm = new Button("Confirm");
	private Button cancel1 = new Button("cancel1");
	private Button cancel2 = new Button("cancel2");

	private Panel p = new Panel();
	private Panel p1 = new Panel();

	// private Panel p = new Panel(new GridLayout(1,2,10,10))

	private BorderLayout bl = new BorderLayout();
	private GridLayout gl = new GridLayout(1, 2, 10, 10);
	private GridLayout g2 = new GridLayout(2, 1, 0, 0);
...
public class Exam_09 {
	...
	public static void main(String[] args) {
		Exam_09_Sub ex = new Exam_09_Sub();
