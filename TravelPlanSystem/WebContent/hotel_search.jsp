		...
		<form action="hotel_search.do" method="post" name="frm">
			...
			<div id="wrap" align="center">
				<c:if test="${! empty hotelList }">
					...
					<h2>検索した条件で ${hotelList.size() }件のホテル情報が検索されました</h2>
					<table>
						<tr>
							<c:forEach var="h" items="${hotelList }" varStatus="i">
								<td height="300" width = "300"><a href="hotel_select.do?hotelName=${h.hotelName }">
								 ...
								 <br><br><div style="width:180px"><b>ホテル名:</b> ${h.hotelName }</div><b>料金:</b>
									￥${h.hotelPrice }<br> <b>評点:</b> <fmt:formatNumber value="${selectedHotel[0].avgReviewGrade }" pattern=".0"/>点<br><br></td>
								<td>
